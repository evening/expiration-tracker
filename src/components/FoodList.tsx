      ...
      <div className='grid grid-rows-3 lg:grid-cols-3 gap-4  '>
        <div>
          ...
          <div className="grid grid-cols-5">
            ...
            {entries.filter(entry => entry.location === FoodLocation.fridge && entry.foodName.includes(searchTerm))
              .map((food, index) =>
                <Fragment key={index}>
                  <FoodItem food={food} />
        ...
        <div>
          ...
          <div className="grid grid-cols-5">
            ...
            <div className='col-span-1 font-semibold mx-auto'> Status </div>
            <div className='col-span-2 font-semibold mx-auto'> Action </div>
            {entries.filter(entry => entry.location === FoodLocation.freezer && entry.foodName.includes(searchTerm))
              .map((food, index) =>
                <Fragment key={index}>
                  <FoodItem food={food} />
                  <div className='col-span-2'>
        ...
        <div>
          ...
          <div className="grid grid-cols-5">
            ...
            <div className='col-span-1 font-semibold mx-auto'> Status </div>
            <div className='col-span-2 font-semibold mx-auto'> Action </div>
            {entries.filter(entry => entry.location === FoodLocation.pantry && entry.foodName.includes(searchTerm))
              .map((food, index) =>
                <Fragment key={index}>
                  <FoodItem food={food} />
                  <div className='col-span-2'>
